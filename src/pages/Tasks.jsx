      ...
      <div className="col-span-9 px-10 pt-10">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-5">
            ...
            {/* <Modal isOpen={isOpen} setIsOpen={setIsOpen} title='test title'>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eligendi dolorem unde iusto necessitatibus impedit corrupti voluptatum veniam voluptas quidem, consequuntur minima quo assumenda tenetur mollitia, a cumque ad eos sapiente?</p>
